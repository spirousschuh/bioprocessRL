...
class kiwiGymEnv_CS1_0(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        d_vector=np.tile([21],(self.kiwiGym.final_time-int(self.kiwiGym.pulses_time[0]-1*0))*self.kiwiGym.num_experiments)
    ...
    def reset(self, seed=None, options=None):
        ...
        while self.kiwiGym.current_time<round(self.kiwiGym.pulses_time[0]-time_step_before):
            ...
            index_obs=np.arange(2*self.kiwiGym.num_experiments)+2*self.kiwiGym.num_experiments*(self.kiwiGym.current_time-1)+(self.kiwiGym.num_experiments)*(self.kiwiGym.final_time-int(self.kiwiGym.pulses_time[0]-1*0))+1
    ...
    def step(self, action):
        ...
        index_action=np.arange(self.kiwiGym.num_experiments)+self.kiwiGym.num_experiments*(self.kiwiGym.current_time-int(self.kiwiGym.pulses_time[0])-1*0)+1
