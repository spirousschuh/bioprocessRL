...
class kiwiGymEnv_CS2_0(gym.Env):
    ...
    def __init__(self, render_mode=None):
        ...
        y_vector=np.tile([20]+[105],(self.kiwiGym.final_time)*self.kiwiGym.num_experiments)
    ...
    def reset(self, seed=None, options=None):
        ...
        time_step_before=1
        obs[0]=int(self.kiwiGym.pulses_time[0]-time_step_before)
        ...
        while self.kiwiGym.current_time<round(self.kiwiGym.pulses_time[0]-time_step_before):
            ...
            index_obs=np.arange(2*self.kiwiGym.num_experiments)+2*self.kiwiGym.num_experiments*(self.kiwiGym.current_time-1)+(self.kiwiGym.num_experiments)*(self.kiwiGym.final_time-int(self.kiwiGym.pulses_time[0]))+1
